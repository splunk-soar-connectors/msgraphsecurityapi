...
MS_GRAPHSECURITYAPI_INVALID_STATUS_MSG = "Please provide valid value for 'Status' parameter"
MS_GRAPHSECURITYAPI_EMPTY_RESP_MSG = "Status Code {}. Empty response and no information in the header."
...
MS_GRAPHSECURITYAPI_QUARTER_SEC_WAIT_BW_APIS = 0.25

# Input constants
MS_GRAPHSECURITYAPI_TOP_PARAM_UPPER_LIMIT = 1000
# Status parameter is case sensitive
MS_GRAPHSECURITYAPI_VALUE_LIST_OF_STATUSES = ("unknown", "newAlert", "inProgress", "resolved")
